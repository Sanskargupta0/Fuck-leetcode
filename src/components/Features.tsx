...
const FeatureCard = ({ icon, title, description, index }: FeatureCardProps) => {
  ...
  return (
    <div 
      ref={cardRef}
      className={cn(
        "feature-card glass-card opacity-0 p-4 sm:p-6 lg:p-8",
        "lg:hover:bg-gradient-to-br lg:hover:from-white lg:hover:to-pulse-50",
        "transition-all duration-300 h-full"
      )}
      style={{ animationDelay: `${0.1 * index}s` }}
    >
      <div className="rounded-full bg-pulse-50 w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 flex items-center justify-center text-pulse-500 mb-4 sm:mb-5 flex-shrink-0">
        {icon}
      </div>
      <h3 className="text-base sm:text-lg lg:text-xl font-semibold mb-2 sm:mb-3 leading-tight">{title}</h3>
...
const Features = () => {
  ...
  return (
    <section className="py-8 sm:py-12 lg:py-16 xl:py-20 pb-0 relative bg-gray-50 overflow-hidden" id="features" ref={sectionRef}>
      <div className="section-container">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16 px-4 sm:px-0">
          ...
          <h2 className="section-title text-2xl sm:text-3xl lg:text-4xl xl:text-5xl mb-3 sm:mb-4 opacity-0 fade-in-element leading-tight">
            Advanced Intelligence, <br className="hidden sm:block" />Human-Like Intuition
          </h2>
          <p className="section-subtitle text-sm sm:text-base lg:text-lg mx-auto opacity-0 fade-in-element max-w-2xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 px-4 sm:px-0">
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7"><path d="M12 2a10 10 0 1 0 10 10 4 4 0 1 1-4-4"></path><path d="M12 8a4 4 0 1 0 4 4"></path><circle cx="12" cy="12" r="1"></circle></svg>}
          ...
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"></path><path d="m14.5 9-5 5"></path><path d="m9.5 9 5 5"></path></svg>}
